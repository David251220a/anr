...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <u><h3 align="center" ><strong>Resumen de Votos de: {{$intendente->intendente}}</strong></h3></u>
                ...
                <div class="table table-responsive table-bordered">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            @foreach ($votacion_intendente as $inte)
                                ...
                                @if($inte->Id_Local == $loca->Id_Local)
                                    ...
                                    @php
                                        $total_local = $inte->total_local;
                                    @endphp

                                @endif

                                @php
                                    $total_general = $inte->total_general;
                                @endphp
