...
@section('contenido')
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-8">
            ...
            {!! Form::open(array('route' => 'consulta.referente_consejal', 'method'=>'GET', 'autocomplete'=>'off', 'role'=>'search')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <select name="referente" id="referente" class="form-control selectpicker"  data-live-search="true">
                            ...
                            <option value="98" @if(98 == $referente) selected="selected" @endif>LISTADO COMPROMETIDOS</option>
    ...
    <div class="row" style="text-align: center">
        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-8">
            ...
            @if (99 == $referente)
                ...
                <a class="btn btn-secondary btn-sm float-right" href=" {{ route('referente_consejal') }} " target="_blank">
            ...
            @if ($comprometidos)
                ...
                <a class="btn btn-secondary btn-sm float-right" href=" {{ route('referente_inte_pdf', $referente) }}" target="_blank">
                    <button class="btn btn-info"><li  class="fa fa-file-pdf-o"></li> PDF</button>
                </a>
                    ...
                    <div class="table-responsive">
                        ...
                        <table  id="example" class="table table-striped table-condensed table-bordered table-hover table-responsive">
                            ...
                            <thead style="background-color:#f71808a8">
                                ...
                                <tr>
                                    <td colspan="6" style="text-align: center">LISTA 1 - OPCION: {{$Id_Consejal}} / {{$nombre}} {{$apellido}}</td>
                                </tr>
                                <td style="text-align: center">Cedula</td>
                                <td style="text-align: center">Apellido y Nombre</td>
                                <td style="text-align: center" width="70px">C</td>
                                <td style="text-align: center" width="70px">V</td>
                            ...
                            <tbody>
                                ...
                                @foreach ($totales as $total)
                                    ...
                                    <tr>
                                        <td style="text-align: right">{{number_format($total->cedula, 0, ".", ".")}}</td>
                                        <td style="text-align: center">{{$total->apellido_nombre}}</td>
                                        <td style="text-align: center" width="70px">{!! Form::checkbox('comprometido', null, $total->comprometido) !!} </td>
                                        <td style="text-align: center" width="70px">{!! Form::checkbox('voto', null, $total->voto) !!} </td>
                                        <td style="text-align: center">{{$total->apellido_nombre_Referente}}</td>
                                        <td style="text-align: center">{{$total->name}}</td>
                                    </tr>
                        ...
                        <table class="table table-striped table-condensed table-bordered table-hover table-responsive">
                            ...
                            <thead style="background-color:#f71808a8">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: right"> <b> {{number_format($total_voto, 0, ".", ".")}} </b></th>
