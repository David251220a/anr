...
role="dialog" tabindex="-1" id="modal-edit-{{$vot->Id_Votacion_Consejal}}">

{!! Form::open(array('action'=> array('Consulta_ConsejalController@destroy', $vot->Id_Votacion_Consejal), 'method'=>'delete', 'file'=>'true', 'enctype'=>"multipart/form-data" ) ) !!}
        ...
        <div class="modal-content">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                ...
                <div class="form-group">
                    ...
                    <label for="recipient-name" class="col-form-label">Consejal:</label>
                    <input type="text" value="{{$vot->Nombre}} {{$vot->Apellido}}" readonly name="consejal" class="form-control">
                    <input type="hidden" value="{{$vot->Id_Consejal}}" name="id_consejal" class="form-control">
